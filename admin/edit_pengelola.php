...
if (isset($_GET['id'])) {
    ...
    $pengelolaData = $result->fetch_assoc();
    $stmt->close();

    if (!$pengelolaData) {
        $message = "<div class='error-message'>Data pengelola tidak ditemukan.</div>";
    }
}
                    ...
                    <?php if ($pengelolaData): ?>
                        <form method="POST" class="form-edit-user">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" id="email" name="email" value="<?php echo htmlspecialchars($pengelolaData['email']); ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="password">Password (kosongkan jika tidak ingin diubah)</label>
                                <input type="password" id="password" name="password" placeholder="Masukkan password baru">
                            </div>
                            <button type="submit" name="update_pengelola" class="update-btn-form">Update Pengelola</button>
                        </form>
                    <?php else: ?>
                        <p>Data pengelola tidak ditemukan. Silakan kembali ke <a href="manage_pengelola.php">daftar pengelola</a>.</p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
